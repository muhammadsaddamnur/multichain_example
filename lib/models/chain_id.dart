// source : https://chainlist.org/_next/data/odnxOFQH2NmEng_Ns6PSB/index.json

class ChainId {
  static Map<String, dynamic> returnChain(String id) {
    return (chains['pageProps']['sortedChains'] as List)
            .firstWhere((element) => element['chainId'].toString() == id)
        as Map<String, dynamic>;
  }

  static Map<String, dynamic> chains = {
    "pageProps": {
      "sortedChains": [
        {
        ...
        },
        {
          ...
          "infoURL":
              "https://docs.oasis.dev/general/developer-resources/overview",
          "shortName": "oasis",
          "chainId": 42262,
          "networkId": 42262,
          "explorers": [
          ...
          "explorers": [
            {
              "name": "WAGMI Explorer",
              "url":
                  "https://subnets.avax.network/wagmi/wagmi-chain-testnet/explorer",
              "standard": "EIP3091"
            }
          ]
        },
